...
# Inicializa o sensor DHT22 no pino 18
...
sta_if.connect("Wokwi-GUEST", "")  # Conecta à rede WiFi com SSID "Wokwi-GUEST" e sem senha
...
if conectado:
  ...
  while True:
    ...
    time.sleep(1)  # Espera 1 segundo antes de medir novamente
else:
